...
<main>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="servicos" class="nav-link px-2 text-secondary">Serviços</a></li>
  ...
  <p> A primeira palavra para esta resposta é qualidade, com os melhores e mais novos cortes e um ótimo estilo para impressionar todos
    ao redor. Contamos com Cortes Masculinos e Barbas estilizadas, Confira já nosso serviço!</p>

  <br>
  <br>
    <a href = "cortes">
    <img src ="img/Cortes.png">
    </a>
