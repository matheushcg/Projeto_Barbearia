...
<main>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="barba" class="nav-link px-2 text-secondary">Barba</a></li>
  ...
  <h1><b>BARBA NAVALHA</b></h1>
  <br>
  <img src ="img/barba_navalha.jpg">
  <br>
  <br>
  <h3> Tradicional técnica de barbear somada a uma relaxante toalha quente, óleo pré-shave, espuma de barbear aquecida. 
    Processo finalizado com massagem relaxante para ativar a circulação</h3>
  <br>
  <hr>

  <h1><b>BARBA MÁQUINA</b></h1>
  <br>
  <img src ="img/barba_maquina.jpg">
  <br>
  <br>
  <h3> Técnica exclusiva criada pela Na Régua Barbearia para aparar e demarcar a barba utilizando máquinas de corte, 
    máquinas de acabamento e tesoura.</h3>
  <br>
  <hr>
